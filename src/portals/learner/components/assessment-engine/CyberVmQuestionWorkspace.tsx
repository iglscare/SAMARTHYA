  ...
  return (
    <div className="w-full space-y-6 text-left">
      ...
      <div className="space-y-3.5 pt-1">
        <div className="text-base font-bold text-[#0B1E48]">
          Instructions
        </div>
      ...
      <div className="space-y-2">
        <button
          ...
          className="w-full py-3.5 px-6 rounded-xl bg-[#1D4ED8] hover:bg-[#1E40AF] active:scale-[0.99] text-white font-bold text-sm sm:text-base flex items-center justify-center shadow-sm hover:shadow-md transition-all cursor-pointer"
        >
      ...
      <div className="space-y-2.5 pt-2">
        <div className="flex items-center justify-between">
          ...
          {hasReceivedFromTab && (
            <span className="text-[11px] font-semibold text-emerald-600 bg-emerald-50 px-2.5 py-0.5 rounded-full border border-emerald-200/60 animate-fadeIn">
              IP Synced from VM Session
            </span>
          )}
        </div>
        ...
        {submittedStatus === 'correct' && (
          <div className="p-3 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs animate-fadeIn">
            <span>
