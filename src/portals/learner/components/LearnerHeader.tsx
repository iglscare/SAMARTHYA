  ...
  return (
    <header className="w-full bg-transparent sticky top-0 z-30 py-1 sm:py-2">
      ...
      <div className="w-full max-w-[1700px] mx-auto px-3 sm:px-6 lg:px-8 flex items-center justify-between h-16 sm:h-20 lg:h-24">
        ...
        <nav className="hidden lg:flex items-center space-x-1 xl:space-x-3 px-4 xl:px-7 py-2.5 xl:py-3.5 rounded-full bg-[#FFFBF7]/95 border border-[#FFEEDD] shadow-xs backdrop-blur-md text-xs xl:text-[14px] font-bold text-slate-800">
          ...
          <div className="relative">
            <button
              ...
              className={`relative py-1.5 px-2.5 xl:px-4 text-xs xl:text-[14px] font-extrabold transition-colors select-none group cursor-pointer flex items-center space-x-1 ${
                isProfileActive || profileMenuOpen ? 'text-slate-900 font-black' : 'text-slate-700 hover:text-slate-900'
              }`}
            >
              <div className="relative py-1 flex items-center space-x-1">
                <span className="leading-tight">{t('nav.profile', 'Profile')}</span>
                <ChevronDown
                  className={`h-3.5 w-3.5 text-slate-500 group-hover:text-slate-900 transition-transform duration-200 ${
                  ...
                  <div className="py-2 space-y-1">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <span className="block font-bold truncate">Officer Profile & Dossier</span>
                        <span className="text-[10px] text-slate-500 font-normal block truncate">Civil service record & credentials</span>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <span className="block font-bold truncate">Digital Smart ID Pass</span>
                        <span className="text-[10px] text-slate-500 font-normal block truncate">DigiLocker verified identity pass</span>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <span className="block font-bold truncate">Sync iGOT & Refresh Data</span>
                        <span className="text-[10px] text-slate-500 font-normal block truncate">Update learning telemetry</span>
                      </div>
                    </button>
                  </div>
      ...
      <div className="w-full bg-[#E8F1FC] border-t border-b border-slate-200/80 py-3 sm:py-4 px-3 sm:px-6 lg:px-8">
        <div className="w-full max-w-[1700px] mx-auto flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3">
          {/* Welcome Text */}
          <div className="min-w-0">
            ...
            <p className="text-[11px] sm:text-[13px] text-slate-600 font-medium mt-0.5 line-clamp-1 sm:line-clamp-none">
              {t('banner.subtitle', 'Track your progress, enhance your skills and grow professionally.')}
            </p>
          </div>

          {/* Timestamp & Refresh Icon */}
          <div className="flex items-center space-x-1.5 text-[11px] sm:text-xs text-slate-500 font-medium self-start sm:self-center shrink-0">
            <span>{t('banner.lastUpdated', 'Last updated')}: {t('banner.timeString', '20 May 2025, 09:30 AM')}</span>
            <button
              type="button"
              onClick={handleRefresh}
              className={`p-1 text-slate-500 hover:text-slate-800 hover:bg-blue-200/50 rounded-full transition-all cursor-pointer ${
