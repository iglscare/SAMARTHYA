...
export const DepartmentLayout: React.FC = () => {
  return (
    <div className="flex min-h-screen flex-col bg-[#F0F5FE] text-slate-900 font-sans selection:bg-blue-100 relative overflow-x-clip antialiased">
      {/* Decorative Sovereign Watermark Background */}
      ...
      {/* Top Navbar matching Learner Header design */}
      <div className="print:hidden">
        <DepartmentHeader />
      </div>

      {/* Main Content Viewport */}
      <main className="flex-1 animate-fade-in relative z-10 p-4 sm:p-6 lg:p-8 pb-20 print:p-2 print:m-0">
        <div className="mx-auto max-w-[1720px]">
          <Outlet />
        </div>
      </main>

      {/* SIH Floating Persona Switcher */}
      <div className="print:hidden">
        <PersonaSwitcher />
      </div>
    </div>
